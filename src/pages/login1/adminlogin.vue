      ...
      <div class="dialog dialog-shadow" style="display: block; margin-top: -362px;">
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            <ul class="common-form" style="list-style:none">
            ...
            <div style="margin-bottom: 30px;">
              <y-button
                :classStyle="registered.userPwd&&registered.userName&&registxt==='登陆'?'main-btn':'disabled-btn'"
                :text="registxt"
            ...
            <ul class="common-form pr" style="list-style:none">
...
export default {
  ...
  methods: {
    ...
    regist () {
      ...
      login({lx:'login',username:userName,password:userPwd}).then(res => {
           console.log(res)
          if (res.code ===200) {
            this.messageSuccess()
