        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            ...
            <div style="margin-bottom: 30px;">
              <el-button
                :aria-disabled="registered.userPwd&&registered.userPwd2&&registered.userName?'true':'false'"
                :text="registxt"
                style="margin: 0;width: 90%;height: 24px;font-size: 18px;line-height: 24px"
                @click="regist"
              >注册
              </el-button>
            </div>
...
export default {
  ...
  methods: {
    ...
    regist(){
      register({lx:register,username:this.registered.userName,password:this.registered.userPwd,email:'',phone:'',address:''}).then(response => {
...
@media screen and (min-width: 737px),
  screen and (-webkit-max-device-pixel-ratio: 1.9) and (max-width: 736px) and (min-width: 737px) {
  .wrapper {
