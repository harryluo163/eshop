...
// import { setStore,removeStore } from '../../../utils/storage.js'
...
export default {
  ...
  methods: {
    ...
    handlelogin() {
      ...
      login({lx:'login',username:this.ruleForm.userName, password:this.ruleForm.userPwd}).then(res => { 
        //打印测试
        // console.log('---------------',res)
