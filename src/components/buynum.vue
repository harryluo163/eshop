<template>
  ...
  <el-input-number v-model="Num"  :min="1" :max="limit" @change="handlechange" label="描述文字"></el-input-number>
...
<script>
  export default {
    ...
    methods:{
      handlechange(value){
        // console.log(value,this.id,this.checked)
      this.$emit("change", {value:value,id:this.id,checked:this.checked}) 
